...
<form id="addform" class="row g-3" action="/addform" method="POST" enctype="multipart/form-data">
...
@csrf
 ...
 <input required name="food_name" id="in1" type="text" class="form-control" placeholder="food name" aria-label="food name">
  </div>
