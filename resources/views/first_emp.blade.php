...
<!-- <span class="iconify" style="margin-left: -30%;margin-top: -5%;" data-icon="fluent:syringe-20-regular" style="color: white;"></span> -->
  <div class=" value" style="margin-top: -5%;" akhi="700">0</div>
  </div>
...
<br/>
  <div class="info-counter-text" style="margin-top:-27%;width: 270px; margin-left:-15%;">Average yearly of happy clients</div>
