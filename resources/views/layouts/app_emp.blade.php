...
<li class="nav-item">
<a class="nav-link active"aria-current="page" href="/first_emp">Home</a>
</li>
...
@if(!Session::has('position') =='Doctor')
<li class="nav-item">

<a class="nav-link"href="/drreservations">DReservations</a>

</li>
@else
<li class="nav-item">
<a class="nav-link"href="/trreservations">TReservations</a>
</li>
@endif
<li class="nav-item">
